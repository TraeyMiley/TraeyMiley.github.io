...
var _nav={_body:document.body,_head:document.getElementsByTagName("head")[0],_first:document.body.firstChild,isie6:function(){return(/MSIE 6.0/ig.test(navigator.appVersion))},isie:function(){return navigator.userAgent.indexOf("MSIE")!=-1},elem:function(o){return document.createElement(o)},id:function(o){return document.getElementById(o)},showNav:function(_html,_css){if(document.getElementsByTagName("style").length==0){if(_nav.isie()){document.createStyleSheet()}else{_nav._head.appendChild(elem("style"))}};var _style=document.getElementsByTagName("style")[0];if(_nav.isie()){_style.styleSheet.cssText+=_css}else{_style.appendChild(document.createTextNode(_css))}var _navbox=_nav.elem("div");_navbox.className="dnfact_navbg";_navbox.innerHTML=_html;_nav._body.insertBefore(_navbox,_nav._first)},_html:"",_css:""};_nav._body.style.cssText="background-position:50% 130px;";
    var _navdata=[
		{link:'http://dnf.qq.com/cp/a20170921return/',title:'冒险家征集令',title2:'多重豪礼来袭'},
		{link:'http://dnf.qq.com/cp/a20170921ship/',title:'出击！净化号！',title2:'拿技能宝珠'},
		{link:'http://dnf.qq.com/cp/a20170921level/',title:'全职业升级',title2:'传说装备大放送'},
		{link:'http://dnf.qq.com/cp/a20170921sign/',title:'欢天喜地度国庆',title2:'登录有惊喜'},
		{link:'http://dnf.qq.com/cp/a20170921pack/',title:'国庆礼包',title2:'提督有令海军集合'},
		{link:'http://dnf.qq.com/cp/a20170921point/',title:'国庆积分商城',title2:'积分商城再开业！'},
		{link:'http://dnf.qq.com/cp/a20170921box/',title:'10月魔盒来袭',title2:'卢克爷爷强化奥秘'},
		{link:'http://dnf.qq.com/cp/a20170831version/index.htm',title:'王者公会谁与争锋',title2:'公会战赛季结束'},
		{link:'http://dnf.qq.com/cp/a20170921nd/',title:'舰船地下城',title2:'得国庆武器装扮'}
        ],//增加导航按钮数量，改变数组长度即可
        navwidth=1080;
        ...
        for(i=0;i<_navdata.length;i++){
            _nav._html+='<li'+(i==0?' class="s"':'')+'><a href="'+_navdata[i].link+'" target="_blank"><strong>'+_navdata[i].title+'</strong>'+_navdata[i].title2+'</a></li>';
        }
        _nav._html+='</ul><ul class="_act_btn"><li><a href="/act.shtml" target="_blank">活动中心</a></li><li><a href="/v/" target="_blank">视频中心</a></li></ul></div>';
...
_delay_js("//dnf.qq.com/cp/a20170505img/public-img.js");
//_delay_js("//ossweb-img.qq.com/images/comm/sign.js");
/*_loadjs("//ossweb-img.qq.com/images/js/login/loginmanagerv3.js",function(){
    LoginManager.checkLogin(function(){
        if($E("#login_qq_span")){$E("#login_qq_span").innerHTML = LoginManager.getUserUin();}
        _chkIsFavorAct();//判断活动是否已收藏过
    });
});*//*  |xGv00|fb3a6b2d4568b3b2d7aa480a6e703d8d */